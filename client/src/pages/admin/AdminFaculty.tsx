  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="page-title gradient-text">Faculty Management</h1>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-orange-100 to-orange-50 dark:from-orange-950/30 dark:to-orange-900/20 border-b-2 border-orange-200 dark:border-orange-900/30">
                  <th className="px-6 py-4 text-left text-xs font-bold text-orange-900 dark:text-orange-100 uppercase tracking-wider">Employee ID</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-orange-900 dark:text-orange-100 uppercase tracking-wider">Faculty</th>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-bold text-orange-900 dark:text-orange-100 uppercase tracking-wider">Assignments</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-orange-900 dark:text-orange-100 uppercase tracking-wider">Joined</th>
              ...
              <tbody className="divide-y divide-border">
                {faculty.map((fac) => {
                  const assignmentCount = fac.timetable_count || 0;
                  return (
                    <tr key={fac.id} className="hover:bg-orange-50/50 dark:hover:bg-orange-950/10 transition-colors duration-150">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="font-mono font-semibold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/30 px-3 py-1 rounded-md">{fac.employee_id}</span>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-200 border border-orange-200 dark:border-orange-800">
                          {fac.departments?.code || '-'}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${assignmentCount > 0 ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-yellow-100 text-yellow-800 border border-yellow-200'}`}>
                            {assignmentCount} {assignmentCount === 1 ? 'class' : 'classes'}
                          </span>
                          {assignmentCount === 0 && (
                            <button
