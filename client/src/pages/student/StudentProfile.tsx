...
export default function StudentProfile() {
  ...
  console.log('[StudentProfile] Department data (direct):', JSON.stringify(profile.departments, null, 2));
  console.log('[StudentProfile] Department data (via section):', JSON.stringify(profile.sections?.departments, null, 2));
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="card-base p-6">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-32 h-32 rounded-full gradient-primary flex items-center justify-center text-4xl font-bold text-white mx-auto md:mx-0">
            {initials}
          </div>
