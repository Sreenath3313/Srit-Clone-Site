...
export const About: React.FC = () => {
  ...
  const particleCount = isMobile ? PARTICLE_COUNT.ABOUT_MOBILE : PARTICLE_COUNT.ABOUT_DESKTOP;
  const gridCount = isMobile ? GRID_COUNT.ABOUT_MOBILE : GRID_COUNT.ABOUT_DESKTOP;
